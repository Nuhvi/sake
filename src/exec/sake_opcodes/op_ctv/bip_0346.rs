...
mod test_vectors {
    ...
    fn generate_vectors() -> Vec<TestCase> {
        ...
        let selectors: &[(&[u8], Box<dyn Any>)] = &[
            ...
            (
                &[all, TXFS_OUTPUTS_SCRIPTPUBKEYS, 0, number | selcur],
                r(..nbout),
            ),
            (&[all, TXFS_OUTPUTS_VALUES, 0, number | selcur], r(..nbout)),
            (&[all, TXFS_OUTPUTS_ALL, 0, number | selcur], r(..nbout)),
            (
                &[all, TXFS_OUTPUTS_SCRIPTPUBKEYS, 0, number | selall],
                r(..),
            ),
            ...
            (
                &[all, TXFS_INPUTS_PREV_SCRIPTPUBKEYS, number | selcur],
                r(..),
            ),
            ...
            (
                &[all, TXFS_INPUTS_PREV_SCRIPTPUBKEYS, number | selall],
                r(..),
            ),
            ...
            // leading
            (
                &[all, allio, leading | 0x01, number | leading | 0x02],
                r(..),
            ),
            ...
            (
                &[
                    all,
                    allio,
                    individual | absolute | 0x01,
                    0x01,
                    individual | absolute | 0x02,
                    0x00,
                    0x02,
                ],
                r(..),
            ...
            (
                &[
                    all,
                    allio,
                    number | individual | absolute | 0x01,
                    0x01,
                    number | individual | absolute | 0x02,
                    0x00,
                    0x02,
                ],
                r(..),
            ...
            (
                &[
                    all,
                    allio,
                    individual | relative | 0x01,
                    (-1i8 as u8) >> 1,
                    individual | relative | 0x02,
                    (-1i8 as u8) >> 1,
                    0,
                ],
                r(1..nbout),
            ...
            (
                &[
                    all,
                    allio,
                    number | individual | relative | 0x01,
                    (-1i8 as u8) >> 1,
                    number | individual | relative | 0x02,
                    (-1i8 as u8) >> 1,
                    0,
                ],
                r(1..nbout),
